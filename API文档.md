...
[51、获取sku详情](#51通过type和id获得sku详情)<br/>
[52、搜索商品](#51通过type和id或time搜索商品)<br/>
...
## 51、通过type和id获得sku详情
### 请求URL：
http://www.equnshang.com/ProductController/getSku.php
### 示例：
无
...
### 返回示例： 
	   [
      {
	vipNormalPrice	"21.0000"
	fanNormalPrice	"56.0000"
	code		"66666"
	purchasePrice	"14.0000"
	vipGroupPrice	"17.5000"
	stock		99999
	lowStock	0
	规格	      "1袋"
	threshold	100000
...
## 52、通过type和id或time搜索商品
### 请求URL：
http://www.equnshang.com/ProductController/getQueryList.php
### 示例：
无
